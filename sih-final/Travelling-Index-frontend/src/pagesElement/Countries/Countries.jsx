  ...
  return (
    ...
    <div className="container-listing-countries m-10">
      <div className="heading-countries mb-7 font-[lora] font-bold flex justify-center text-5xl items-center">
        <p>List Of Cities</p></div>
      <div className="main-card-section flex justify-between flex-wrap">
        <InnerCountries ImageDisplay={displayImage1} Country='Munnar'  TotalReviews='400' Ratings='4.2' />
        <InnerCountries ImageDisplay={displayImage2} Country='Coorg'  TotalReviews='300' Ratings='3.2' />
        <InnerCountries ImageDisplay={displayImage3} Country='Sanchi'  TotalReviews='100' Ratings='2.2' />
        <InnerCountries ImageDisplay={displayImage4} Country='Bundi'  TotalReviews='120' Ratings='4.5' />
        <InnerCountries ImageDisplay={displayImage5} Country='Hampi'  TotalReviews='230' Ratings='4.0' />
      </div>
    </div>
    </>
  )
